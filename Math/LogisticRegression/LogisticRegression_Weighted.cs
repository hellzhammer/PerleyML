...
{
    public class LogisticRegression_Weighted
    {
        private Matrix<double> synapticWeights { get; set; }

        public LogisticRegression_Weighted(int MatrixRows, int MatrixCols)
        {
            synapticWeights = createMatrixWithRandomNumbers(MatrixRows, MatrixCols);
        }
